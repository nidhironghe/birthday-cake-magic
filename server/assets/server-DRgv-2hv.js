...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CRJ5pctT.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D1UKtRO_.js"),
    import("./start-B57R-Mbs.js"),
...
var ROUTER_BASEPATH = "birthday-cake-magic";
var SERVER_FN_BASE = "/birthday-cake-magic/_serverFn/";
